...
- feat: initial public release — Repod Community Edition v1.1.0 (71def73)

### 🐛 Corrections
- fix(settings): notification_rules is a list, not a dict (b149709)
- fix(settings): PATCH /settings/ silently dropped cve_policy and 3 other sections (7eab840)


### 🐳 Images Docker
- `ghcr.io/repod-ce/backend:1.1.1`
- `ghcr.io/repod-ce/frontend:1.1.1`
- `ghcr.io/repod-ce/apt-repo:1.1.1`
- `ghcr.io/repod-ce/rpm-nginx:1.1.1`
## v1.1.0 — 2026-07-17
